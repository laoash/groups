...
public class ArrayUtil {
     ...
     * @return 交换后的数组
     */
    public static Integer[] swap(Integer[] ints, int x, int y) {
        int temp = ints[x];
        ints[x] = ints[y];
        ints[y] = temp;
        return ints;
     ...
     * @return 排序后的数组
     */
    public static Integer[] bubbleSort(Integer[] source) {
     ...
     * @return 排序后的数组
     */
    public static Integer[] insertSort(Integer[] source) {
     ...
     * @return 排序后的数组
     */
    private static Integer[] qsort(Integer source[], int low, int high) {
        int i, j, x;
        if (low < high) {
            i = low;
            j = high;
     ...
     */
    public static Integer binarySearch(Integer[] source, int key) {
     ...
     * @return
     */
    public static Integer[] insert(Integer[] array, int index, int insertNumber) {
        ...
        Integer[] dest=new Integer[array.length+1];
    ...
    public static Integer[] merge(Integer[] array1,Integer[] array2) {
        Integer[] dest=new Integer[array1.length+array2.length];
     ...
     * @return
     */
    public static Integer[] offsetArray(Integer[] array,int offset){
        int length = array.length;
        int moveLength = length - offset;
        Integer[] temp = Arrays.copyOfRange(array, moveLength, length);
     ...
     * @return
     */
    public Integer[] shuffle(Integer[] array) {
    ...
    // 交换位置
    private void exchange(Integer[] array, int p1, int p2) {
        int temp = array[p1];
        array[p1] = array[p2];
        array[p2] = temp;
    }
     ...
     * @return 合并后的排序数组
     */
    public static List<Integer> mergeByList(Integer[] a, Integer[] b) {
     ...
     */
    public static Integer[] mergeByArray(Integer[] a, Integer[] b){
     ...
     * @return
     */
    public static List<Integer> moveLike( Integer[] old,List<Integer> b){
        List<Integer> a = Arrays.asList(old);
        return moveLike(a,b);
    }
    public static List<Integer> moveLike(List<Integer> a,Integer[] old){
            List<Integer> b = Arrays.asList(old);
            return moveLike(a,b);
    }
    public static List<Integer> moveLike(List<Integer>a,List<Integer>b){
     ...
     */
    private static Map<Integer,Integer> mergeByTreeMap(Integer[] a, Integer[] b) {
    ...
    public static void main(String[] args){
        ...
        a.add(4);
        a.add(5);
        Integer[] b = new Integer[]{1,2,4};
        List<Integer> list = moveLike(a,b);
        print(list.toArray(new Integer[list.size()]));
